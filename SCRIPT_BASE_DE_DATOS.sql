...
SELECT ID_PRODUCTO, NOMBRE, MARCA, PRECIO, ALTURA, ANCHURA, PESO, NUM_ELEMENTOS, DESCRIPCION
FROM PRODUCTOS;
...
SELECT ID_EMPLEADO, NOMBRE, APELLIDOS, COD_POSTAL, CORR_ELEC
FROM CLIENTE;
